        ...
        <div className="mt-12 grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-6">
          {integrations.map((name, i) => (
            <Reveal key={name} delay={(i % 6) * 0.04}>
              <div className="flex items-center justify-center gap-2 rounded-2xl border border-surface-muted bg-card px-4 py-6 text-sm font-bold text-ink/70 shadow-soft transition hover:text-ink">

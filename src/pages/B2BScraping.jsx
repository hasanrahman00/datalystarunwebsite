...
const FAQ = [
  ...
  { q: 'How is this cheaper than subscriptions?', a: 'Apollo costs $49-119/mo, ZoomInfo starts at $14,995/year. With VikiLeads you get data from ALL of them per project. Most clients save $10K-30K/year.' },
        ...
        <div className="max-w-[1200px] mx-auto px-6">
          ...
          <Reveal><div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="g-card p-8">
              <h4 className="font-display text-[1.05rem] font-bold mb-6 text-red-400">❌ Without VikiLeads</h4>
            ...
            <div className="g-card p-8">
              <h4 className="font-display text-[1.05rem] font-bold mb-6 text-emerald-400">✅ With VikiLeads</h4>
